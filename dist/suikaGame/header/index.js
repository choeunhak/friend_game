...
var Header = function (_a) {
    ...
    return (_jsxs("div", __assign({ className: cx('headerArea'), style: { maxWidth: getRenderWidth() } }, { children: [_jsxs("div", __assign({ className: cx('bestScoreArea') }, { children: [_jsx("span", __assign({ className: cx('text') }, { children: "BEST" })), _jsx("span", __assign({ className: cx('number') }, { children: getBestScore() }))] })), _jsx("div", __assign({ className: cx('scoreArea') }, { children: _jsx("span", __assign({ className: cx('score') }, { children: score })) })), _jsxs("div", __assign({ className: cx('nextArea') }, { children: [_jsx("span", __assign({ className: cx('text') }, { children: "NEXT" })), _jsx("span", { className: cx('next'), style: { backgroundImage: "url(".concat(require('../../../resource/' + nextItem + '.png'), ")") } })] }))] })));
};
